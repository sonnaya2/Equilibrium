...
hosted database, API, CMS, or second authoring tree. Architecture, the module map, and the rule for
when a change is a patch, a migration, or a baseline re-export: `docs/data-platform.md`; the audit
that retired the original per-domain files: `docs/legacy-data-stage0.md`.
