...
SQLite database, the reports, and everything under `public/data/v2/` — is generated by
`data:rebuild` and ignored by Git. A single record
is corrected with a patch file, never by rewriting a dataset. Details in
