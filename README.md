...
SQLite database, the compatibility JSON a few modules still import, the reports, and the browser
shards under `public/data/v2/` — is generated by `data:rebuild` and ignored by Git. A single record
