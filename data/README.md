...
`npm run data:rebuild` creates `.cache/equilibrium.sqlite` from scratch, applies every patch, validates it, materializes ignored compatibility JSON under `.cache/data/`, and exports ignored browser shards under `public/data/v2/`.
