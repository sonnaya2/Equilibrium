...
- `scripts/sync-planner-supplements.mjs` validates and copies the specialist Slayer, Invention and Archaeology supplements, including collection utilities and relic-preset corrections.
...
Archaeology utility rows describe time, travel and duplicate-mitigation advantages. They never bypass a region, quest, dig-site or collector requirement, and event-only Fixate charge-token supply is not assumed as a baseline League resource.
...
- `research/planner-expansions-archaeology-utilities.json` — Fixate, duplicate mitigation, journal/teleport tools and corrected 2025 relic-preset progression
