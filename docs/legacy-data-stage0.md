...
`reports/research-overlaps.json`, `reports/research-adjudication.json` and
`reports/research-orphans.json`. Those are generated and git-ignored, like every other report here.

Stage 0 classified the inputs; Stage 1 is adjudicating them, and its record is the last two sections.
