/**
 * Guarded entry for `npm run sync:league:disabled` (formerly `sync:league`).
 *
...
console.error(
  [
    "sync:league:disabled — exits 1. It would write an incompatible blessings/relics schema and break the app.",
