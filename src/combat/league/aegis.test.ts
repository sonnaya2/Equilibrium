...
describe("Teragard's Aegis armour conversion", () => {
  it("uses the shared Total Armor Value for 25% / 50% / 75%", () => {
  ...
  it("changes when the shared Total Armor Value changes", () => {
  ...
  it("does not read Defence, prayer, or Fortitude block boosts", () => {
