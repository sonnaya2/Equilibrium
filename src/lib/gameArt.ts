...
const DATA_ICON_ALIASES: Record<string, string> = {
  ...
  "city of um mushroom patch": "city-of-um",
  "city of um soul forge (ensoul production hub)": "city-of-um",
  ...
  "ghostly sole fishing": "ghostly-sole-fishing",
  ...
  "portable skilling stations (ironman craft/deployment permanent note)": "portable-well",
  ...
  "quest cape (lore teleports + tears of guthix)": "quest-cape",
  ...
  "selene necromancy prayer and curse unlocks (city of um)": "city-of-um",
  ...
  "wars retreat permanent hub unlocks": "wars-retreat-hub",
