...
export const REWARD_ICON_BY_LABEL: Record<string, string> = {
  ...
  "spectral sigil": equip("spectral-spirit-shield"),
  ...
  "super attack": skProd("super-restore"),
  "super strength": skProd("super-restore"),
  "super defence": skProd("super-restore"),
  "super magic potion": skProd("super-restore"),
  "super ranging potion": skProd("super-restore"),
