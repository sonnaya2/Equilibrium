...
export const REWARD_ICON_BY_LABEL: Record<string, string> = {
  ...
  "button mushroom": skProd("button-mushroom"),
  "bittercap mushroom": skProd("bittercap-mushroom"),
  "morchella mushroom": skProd("morchella-mushroom"),
  "bittercap mushroom spore": skProd("bittercap-mushroom-spore"),
  dwellberries: skProd("dwellberries"),
  redberries: skProd("redberries"),

  // Wendlewick fish farm harvests
  "wendlewick fish farm": perm("wendlewick-fish-farm"),
  "raw lobster": skProd("raw-lobster"),
  "raw swordfish": skProd("raw-swordfish"),
  "raw shark": skProd("raw-shark"),
  "raw giant crayfish": skProd("raw-giant-crayfish"),
  "giant crayfish": skProd("raw-giant-crayfish"),
  "lobster pool": skProd("raw-lobster"),
  "swordfish pool": skProd("raw-swordfish"),
  ...
  "raw beef": skProd("raw-beef"),
  "raw chicken": skProd("raw-chicken"),
  "raw bird meat": skProd("raw-bird-meat"),
  "raw rat meat": skProd("raw-rat-meat"),
  "raw bear meat": skProd("raw-bear-meat"),
  "cooked meat": skProd("cooked-meat"),
  "cooked chicken": skProd("cooked-chicken"),
  "cooked rabbit": skProd("cooked-rabbit"),

  // Moonrise Dig Site payoffs
  "ring of kayazu": perm("ring-of-kayazu"),
  "tear of inanna": perm("tear-of-inanna"),
  "hungry like the wolf": perm("hungry-like-the-wolf"),
  "hungry like the wolf relic": perm("hungry-like-the-wolf"),
  anzagar: perm("anzagar"),
  "anzagar pet": perm("anzagar"),
  "fang of kayazu": perm("fang-of-kayazu"),
  "guardian's tear": perm("guardians-tear"),
  "guardians tear": perm("guardians-tear"),
  "expensive spices": perm("expensive-spices"),
  ...
  "noxious scythe": equip("noxious-scythe"),
  "noxious staff": equip("noxious-staff"),
  "noxious longbow": equip("noxious-longbow"),
  "noxious weapons": perm("noxious-weapons"),
  "noxious weapon": perm("noxious-weapons"),
  "noxious components": equip("araxxis-fang"),
  "noxious weapon components": equip("araxxis-fang"),
  "noxious scythe components": equip("noxious-scythe"),
  "noxious staff components": equip("noxious-staff"),
  "noxious longbow components": equip("noxious-longbow"),
  "araxxi's eye": equip("araxxis-eye"),
  "araxxis eye": equip("araxxis-eye"),
  "araxxi's fang": equip("araxxis-fang"),
  "araxxis fang": equip("araxxis-fang"),
  "araxxi's web": equip("araxxis-web"),
  "araxxis web": equip("araxxis-web"),
  "spider leg top": equip("spider-leg-top"),
  "spider leg middle": equip("spider-leg-middle"),
  "spider leg bottom": equip("spider-leg-bottom"),
  ...
  "columbarium key": perm("columbarium-key"),
  "columbarium keys": perm("columbarium-key"),
  "shiny columbarium key": perm("shiny-columbarium-key"),
  "shiny columbarium keys": perm("shiny-columbarium-key"),

  // Vyrewatch drop chips
  vyrewatch: perm("vyrewatch"),
  "vyre corpse": perm("vyre-corpse"),
  "congealed blood": skProd("congealed-blood"),
  "death rune": skProd("death-rune"),
  "death runes": skProd("death-rune"),
  "grimy ranarr": skProd("grimy-ranarr"),
  "grimy avantoe": skProd("grimy-avantoe"),
  "grimy snapdragon": skProd("grimy-snapdragon"),
  "splitbark helm": equip("splitbark-helm"),
  "splitbark pieces": equip("splitbark-helm"),
  "morchella mushroom spore": skProd("morchella-mushroom-spore"),
  "morchella mushroom spores": skProd("morchella-mushroom-spore"),
  // Columbarium recess table chips
  "dragon spear": equip("dragon-spear"),
  "blood talisman": perm("blood-talisman"),
  "blood rune": skProd("blood-rune"),
  "blood runes": skProd("blood-rune"),
  "half keys": perm("tooth-half-of-a-key"),
  "half key": perm("tooth-half-of-a-key"),
  "tooth half of a key": perm("tooth-half-of-a-key"),
  "loop half of a key": perm("loop-half-of-a-key"),
  herbs: skProd("grimy-torstol"),
  "high herbs": skProd("grimy-torstol"),
  "grimy torstol": skProd("grimy-torstol"),
  "trail armour (black/adamant/rune g/t)": equip("black-platebody-g"),
  "trail armour": equip("black-platebody-g"),
  "black platebody (g)": equip("black-platebody-g"),
  "rune full helm (g)": equip("rune-full-helm-g"),
  ...
  // Row face uses boss plate via gameArt; reward chip for the major name can stay set body.
  ...
  // Zorgoth's ring (Fremennik necro ring / soul upgrade)
  "zorgoth's ring": equip("zorgoths-ring"),
  "zorgoths ring": equip("zorgoths-ring"),
  "zorgoth's soul ring": equip("zorgoths-soul-ring"),
  "zorgoths soul ring": equip("zorgoths-soul-ring"),
  "zorgoth's soul ring path": equip("zorgoths-soul-ring"),
  "ungael ritual site": perm("ungael-ritual"),
  ...
  "offhand blisterwood sickle": equip("off-hand-blisterwood-sickle"),
  "blisterwood staff": equip("blisterwood-staff"),
  "blisterwood stave": equip("blisterwood-staff"),
  "blisterwood wand": equip("blisterwood-wand"),
  "blisterwood orb": equip("blisterwood-orb"),
  "blisterwood stake": equip("blisterwood-stake"),
  "off-hand blisterwood stake": equip("off-hand-blisterwood-stake"),
  "offhand blisterwood stake": equip("off-hand-blisterwood-stake"),
  "blisterwood stake-thrower crossbow": equip("blisterwood-stake-thrower-crossbow"),
  "blisterwood stake thrower crossbow": equip("blisterwood-stake-thrower-crossbow"),
  "blisterwood weapons": equip("blisterwood-polearm"),
  ...
  "baby yak": perm("baby-yak"),
  "fremennik yak (unchecked)": perm("baby-yak"),
  "yak-hide": perm("yak-hide"),
  "yak hide": perm("yak-hide"),
